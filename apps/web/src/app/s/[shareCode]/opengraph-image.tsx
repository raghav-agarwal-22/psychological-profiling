    ...
    (
      ...
      >
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '48px' }}>
          ...
          <span style={{ fontSize: '18px', color: '#a8a29e', letterSpacing: '0.05em', fontFamily: 'sans-serif', fontWeight: 500 }}>
            innermind
          </span>
        </div>
        ...
        <div style={{ display: 'flex', flex: 1, gap: '64px', alignItems: 'flex-start' }}>
          ...
          {/* Right: Big Five trait tags + bars */}
              ...
              {topDimensions.map(({ key, label, value }) => (
                <div key={key} style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
                  <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                    <span style={{ fontSize: '15px', fontFamily: 'sans-serif', color: '#d6d3d1', fontWeight: 500 }}>
                      {label}
                    </span>
                    <span style={{ fontSize: '14px', fontFamily: 'sans-serif', color: '#f59e0b', fontWeight: 600 }}>
                      {value}
                    </span>
                  </div>
                  <div style={{ height: '8px', width: '100%', backgroundColor: '#292524', borderRadius: '999px', overflow: 'hidden' }}>
                    <div style={{ height: '8px', width: `${value}%`, backgroundColor: '#f59e0b', borderRadius: '999px' }} />
                  </div>
                </div>
              ))}
            </div>
